const parsedTrumpTweets = require('./trumptweetdata')
//old parseText function might delete
...
let generateWordPairs = () => {
  let obj = {}; 
  let array = parsedTrumpTweets;
...
let post = generatePoem(textObj, 1);
console.log(post)
module.export =  post;